package com.missmess.swipeloadview.internal;
...
/**
 * @author wl
 * @since 2018/05/23 14:54
 */
public class ProgressDrawable extends PaintDrawable implements Animatable, AnimatorUpdateListener{
